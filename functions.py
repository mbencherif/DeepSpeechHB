...
train_audio_transforms = nn.Sequential(MSHB.MelSpectrogram(sample_rate=16000, n_mels=128),
                                       MSHB.FrequencyMasking(freq_mask_param=30),
                                       MSHB.TimeMasking(time_mask_param=100))


valid_audio_transforms = MSHB.MelSpectrogram()
...
def GreedyDecoder(output, labels, 
                  label_lengths, 
                  blank_label=28, 
